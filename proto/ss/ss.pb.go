...
const (
	...
	SS_PROTO_TYPE_TRANS_LOGIC_REQ SS_PROTO_TYPE = 10 //logic --> disp --> logic2
	SS_PROTO_TYPE_TRANS_LOGIC_RSP SS_PROTO_TYPE = 11
)
...
//trans logic
type TRANS_LOGIC_CMD int32

const (
	TRANS_LOGIC_CMD_TRANS_CMD_NOTHING         TRANS_LOGIC_CMD = 0
	TRANS_LOGIC_CMD_TRANS_CMD_KICK_OLD_ONLINE TRANS_LOGIC_CMD = 1 //kick old online when new client login
)

// Enum value maps for TRANS_LOGIC_CMD.
var (
	TRANS_LOGIC_CMD_name = map[int32]string{
		0: "TRANS_CMD_NOTHING",
		1: "TRANS_CMD_KICK_OLD_ONLINE",
	}
	TRANS_LOGIC_CMD_value = map[string]int32{
		"TRANS_CMD_NOTHING":         0,
		"TRANS_CMD_KICK_OLD_ONLINE": 1,
	}
)

func (x TRANS_LOGIC_CMD) Enum() *TRANS_LOGIC_CMD {
	p := new(TRANS_LOGIC_CMD)
	*p = x
	return p
}

func (x TRANS_LOGIC_CMD) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TRANS_LOGIC_CMD) Descriptor() protoreflect.EnumDescriptor {
	return file_ss_proto_enumTypes[5].Descriptor()
}

func (TRANS_LOGIC_CMD) Type() protoreflect.EnumType {
	return &file_ss_proto_enumTypes[5]
}

func (x TRANS_LOGIC_CMD) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TRANS_LOGIC_CMD.Descriptor instead.
func (TRANS_LOGIC_CMD) EnumDescriptor() ([]byte, []int) {
...
func (x *SSMsg) GetTransLogicReq() *MsgTransLogicReq {
	if x, ok := x.GetMsgBody().(*SSMsg_TransLogicReq); ok {
		return x.TransLogicReq
	}
	return nil
}

func (x *SSMsg) GetTransLogicRsp() *MsgTransLogicRsp {
	if x, ok := x.GetMsgBody().(*SSMsg_TransLogicRsp); ok {
		return x.TransLogicRsp
	}
	return nil
}
...
type SSMsg_TransLogicReq struct {
	TransLogicReq *MsgTransLogicReq `protobuf:"bytes,30,opt,name=trans_logic_req,json=transLogicReq,proto3,oneof"`
}

type SSMsg_TransLogicRsp struct {
	TransLogicRsp *MsgTransLogicRsp `protobuf:"bytes,31,opt,name=trans_logic_rsp,json=transLogicRsp,proto3,oneof"`
}
...
func (*SSMsg_TransLogicReq) isSSMsg_MsgBody() {}

func (*SSMsg_TransLogicRsp) isSSMsg_MsgBody() {}
...
type MsgTransLogicReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd        TRANS_LOGIC_CMD `protobuf:"varint,1,opt,name=cmd,proto3,enum=ss.TRANS_LOGIC_CMD" json:"cmd,omitempty"`
	Uid        int64           `protobuf:"varint,2,opt,name=uid,proto3" json:"uid,omitempty"`
	MyServ     int32           `protobuf:"varint,3,opt,name=my_serv,json=myServ,proto3" json:"my_serv,omitempty"`
	TargetServ int32           `protobuf:"varint,20,opt,name=target_serv,json=targetServ,proto3" json:"target_serv,omitempty"`
}

func (x *MsgTransLogicReq) Reset() {
	*x = MsgTransLogicReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *MsgTransLogicReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgTransLogicReq) ProtoMessage() {}

func (x *MsgTransLogicReq) ProtoReflect() protoreflect.Message {
	mi := &file_ss_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MsgTransLogicReq.ProtoReflect.Descriptor instead.
func (*MsgTransLogicReq) Descriptor() ([]byte, []int) {
	return file_ss_proto_rawDescGZIP(), []int{10}
}

func (x *MsgTransLogicReq) GetCmd() TRANS_LOGIC_CMD {
	if x != nil {
		return x.Cmd
	}
	return TRANS_LOGIC_CMD_TRANS_CMD_NOTHING
}

func (x *MsgTransLogicReq) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *MsgTransLogicReq) GetMyServ() int32 {
	if x != nil {
		return x.MyServ
	}
	return 0
...
func (x *MsgTransLogicReq) GetTargetServ() int32 {
	if x != nil {
		return x.TargetServ
	}
	return 0
...
func (x *MsgTransLogicRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgTransLogicRsp) ProtoMessage() {}

func (x *MsgTransLogicRsp) ProtoReflect() protoreflect.Message {
	mi := &file_ss_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MsgTransLogicRsp.ProtoReflect.Descriptor instead.
func (*MsgTransLogicRsp) Descriptor() ([]byte, []int) {
	return file_ss_proto_rawDescGZIP(), []int{11}
}

func (x *MsgTransLogicRsp) GetCmd() TRANS_LOGIC_CMD {
	if x != nil {
		return x.Cmd
	}
	return TRANS_LOGIC_CMD_TRANS_CMD_NOTHING
...
func (x *MsgTransLogicRsp) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *MsgTransLogicRsp) GetMyServ() int32 {
	if x != nil {
		return x.MyServ
	}
	return 0
...
func (x *MsgTransLogicRsp) GetTargetServ() int32 {
	if x != nil {
		return x.TargetServ
	}
	return 0
...
func (x *MsgTransLogicRsp) GetIntValue() int64 {
	if x != nil {
		return x.IntValue
	}
	return 0
...
var file_ss_proto_rawDesc = []byte{
	...
	0xf6, 0x04, 0x0a, 0x05, 0x53, 0x53, 0x4d, 0x73, 0x67, 0x12, 0x30, 0x0a, 0x0a, 0x70, 0x72, 0x6f,
	...
	,
	...
	0x73, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x18, 0x17, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0xc2, 0x01, 0x0a, 0x0b, 0x4d, 0x73,
	0x67, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x73, 0x70, 0x12, 0x2a, 0x0a, 0x06, 0x72, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x73, 0x73, 0x2e, 0x55,
	0x53, 0x45, 0x52, 0x5f, 0x4c, 0x4f, 0x47, 0x49, 0x4e, 0x5f, 0x52, 0x45, 0x54, 0x52, 0x06, 0x72,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x13, 0x0a, 0x05, 0x63, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x12, 0x29, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x14, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x73, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x21, 0x0a, 0x0c, 0x6f,
	0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x18, 0x15, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x0b, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x4c, 0x6f, 0x67, 0x69, 0x63, 0x22, 0x7b,
	0x0a, 0x0c, 0x4d, 0x73, 0x67, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x71, 0x12, 0x10,
	...
	,
	...
	0x4c, 0x54, 0x49, 0x5f, 0x4f, 0x4e, 0x10, 0x04, 0x2a, 0x9a, 0x01, 0x0a, 0x12, 0x55, 0x53, 0x45,
	...
	0x4f, 0x55, 0x54, 0x10, 0x04, 0x2a, 0x3f, 0x0a, 0x0a, 0x52, 0x45, 0x47, 0x5f, 0x52, 0x45, 0x53,
	...
	0x5f, 0x45, 0x52, 0x52, 0x10, 0x02, 0x2a, 0x47, 0x0a, 0x0f, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x5f,
	0x4c, 0x4f, 0x47, 0x49, 0x43, 0x5f, 0x43, 0x4d, 0x44, 0x12, 0x15, 0x0a, 0x11, 0x54, 0x52, 0x41,
	0x4e, 0x53, 0x5f, 0x43, 0x4d, 0x44, 0x5f, 0x4e, 0x4f, 0x54, 0x48, 0x49, 0x4e, 0x47, 0x10, 0x00,
	0x12, 0x1d, 0x0a, 0x19, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x5f, 0x43, 0x4d, 0x44, 0x5f, 0x4b, 0x49,
	0x43, 0x4b, 0x5f, 0x4f, 0x4c, 0x44, 0x5f, 0x4f, 0x4e, 0x4c, 0x49, 0x4e, 0x45, 0x10, 0x01, 0x62,
...
var file_ss_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_ss_proto_goTypes = []interface{}{
	...
	(TRANS_LOGIC_CMD)(0),     // 5: ss.TRANS_LOGIC_CMD
	...
	(*MsgTransLogicReq)(nil), // 16: ss.MsgTransLogicReq
	(*MsgTransLogicRsp)(nil), // 17: ss.MsgTransLogicRsp
	(*UserInfo)(nil),         // 18: ss.UserInfo
}
var file_ss_proto_depIdxs = []int32{
	...
	16, // 10: ss.SSMsg.trans_logic_req:type_name -> ss.MsgTransLogicReq
	17, // 11: ss.SSMsg.trans_logic_rsp:type_name -> ss.MsgTransLogicRsp
	2,  // 12: ss.MsgLoginRsp.result:type_name -> ss.USER_LOGIN_RET
	18, // 13: ss.MsgLoginRsp.user_info:type_name -> ss.UserInfo
	3,  // 14: ss.MsgLogoutReq.reason:type_name -> ss.USER_LOGOUT_REASON
	18, // 15: ss.MsgLogoutReq.user_info:type_name -> ss.UserInfo
	3,  // 16: ss.MsgLogoutRsp.reason:type_name -> ss.USER_LOGOUT_REASON
	4,  // 17: ss.MsgRegRsp.result:type_name -> ss.REG_RESULT
	5,  // 18: ss.MsgTransLogicReq.cmd:type_name -> ss.TRANS_LOGIC_CMD
	5,  // 19: ss.MsgTransLogicRsp.cmd:type_name -> ss.TRANS_LOGIC_CMD
...
func file_ss_proto_init() {
	...
	file_ss_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*SSMsg_RegReq)(nil),
		(*SSMsg_RegRsp)(nil),
		(*SSMsg_TransLogicReq)(nil),
		(*SSMsg_TransLogicRsp)(nil),
	}
	type x struct{}
